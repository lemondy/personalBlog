      ...
      <article className="prose dark:prose-invert">
        ...
        <ul>
          <li>
            <strong>推送时机：</strong>
            推送时间的策略经过3个版本迭代：
            <b>第一版：</b>根据app活跃峰值时间点确定推送时间，和产品一起确定早上7点、上午10点、晚上19点三个固定的推送时间点；
            <b>第二版：</b>根据用户在App内过去30天活跃数据，建设粗略版本用户常活跃时间段，然后在用户常活跃时间前半个小时进行推送；
            <b>第三版：</b>根据腾讯系设备活跃实时信号，消费实时kafka设备活跃数据，实时推送；
          </li>
          <li>
            <strong>人书召回</strong>
          </li>
